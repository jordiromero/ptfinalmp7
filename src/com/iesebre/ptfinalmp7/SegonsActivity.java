...
public class SegonsActivity extends ListActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		dades.add(new ListaEntrada(R.drawable.ic_ternasco, "Ternasco", "Del millor corder tendre, tendre"));
		dades.add(new ListaEntrada(R.drawable.ic_sepia, "Sopa de Verdura", "Sopa de verdura feta en verdures recient collide del hort"));
